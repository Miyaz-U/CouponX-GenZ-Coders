...
form.addEventListener("submit", async function (event) {
        ...
        try {
            ...
            if (!result.success) {
                ...
                message.className = "text-sm text-center mt-5 text-red-400";
                return;
            }
            message.textContent = "Coupon created successfully!";
            message.className = "text-sm text-center mt-5 text-green-400";
            form.reset();
